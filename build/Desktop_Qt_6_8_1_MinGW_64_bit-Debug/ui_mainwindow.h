...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        formLayout_5->setSizeConstraint(QLayout::SizeConstraint::SetMaximumSize);
        ...
        simulation_interval_input->setSingleStep(100);
        ...
        formLayout_4->setWidget(2, QFormLayout::FieldRole, generator_generatortype_input);

        verticalSpacer_3 = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        formLayout_4->setItem(3, QFormLayout::LabelRole, verticalSpacer_3);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_11->setText(QCoreApplication::translate("MainWindow", "Frequency", nullptr));
